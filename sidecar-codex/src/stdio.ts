/**
 * Synced copy of `sidecar/src/stdio.ts` — see protocol.ts's header comment for why
 * this is a copy rather than a cross-package import.
 */
...
export function log(...args: unknown[]): void {
  console.error('[sidecar-codex]', ...args);
}
